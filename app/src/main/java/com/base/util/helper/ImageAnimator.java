...
public class ImageAnimator {
    ...
    ImageAnimator(CollapsingToolbarLayout collapsingToolbar, ImageView targetImage, ImageView outgoingImage,String[] Images) {
        this.collapsingToolbar = collapsingToolbar;
        mTargetImage = targetImage;
        mOutgoingImage = outgoingImage;
        mImages = new String[Images.length];
        mColors = new int[Images.length];
        ...
        BindingUtils.loadImg(mTargetImage, mImages[0],null);
    ...
    public void start(int startPosition, int endPosition) {
        ...
        BindingUtils.loadImg(mTargetImage,mImages[endPosition],null);
