...
public class PagerChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public static PagerChangeListener newInstance(CollapsingToolbarLayout collapsingToolbar, ImageView originImage, ImageView outgoingImage,String[] mImages) {
        ImageAnimator imageAnimator = new ImageAnimator(collapsingToolbar, originImage, outgoingImage, mImages);
